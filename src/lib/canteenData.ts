...
export const SOUTH_CANTEEN_MENU_SEED: MenuRecord = {
  ...
  categories: [
    ...
    },
    {
      ...
      items: [
        createMenuItem('lunch-chicken-biriyani', 'Special Chicken Biriyani', 120, 'Non-Vegetarian', 1, 'Authentic Dum Biriyani served with Raita, Mirchi Ka Salan & Salad'),
        createMenuItem('lunch-chicken-meal', 'Traditional Chicken Thali Meal', 90, 'Non-Vegetarian', 2, 'Served with Steamed Rice, Chicken Gravy, Rasam, Curd & Pappadam'),
        createMenuItem('lunch-vegetable-meals', 'Executive South Indian Veg Meals', 60, 'Vegetarian', 3, 'Steamed Ponni Rice, Sambar, Rasam, Kootu, Poriyal, Curd & Pickle'),
        createMenuItem('lunch-curd-rice', 'Tempered Curd Rice', 50, 'Vegetarian', 4, 'Creamy curd rice tempered with mustard seeds, curry leaves & pomegranate'),
        createMenuItem('lunch-chapati', 'Soft Tawa Chapati', 10, 'Vegetarian', 5, 'Whole wheat tawa chapati'),
        createMenuItem('lunch-malabar-paratha', 'Flaky Malabar Paratha', 15, 'Vegetarian', 6, 'Layered South Indian flatbread'),
        createMenuItem('lunch-moo-mutter', 'Mutter Paneer Curry', 30, 'Vegetarian', 7, 'Cottage cheese & green peas curry in tomato gravy'),
        createMenuItem('lunch-butter-chicken', 'Creamy Butter Chicken', 60, 'Non-Vegetarian', 8, 'Tender chicken morsels in rich butter tomato sauce'),
      ],
    },
    {
