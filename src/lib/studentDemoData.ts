  ...
  return AUTHORITATIVE_STUDENT_ROSTER.map((authStudent, index) => {
    ...
    return {
      ...
      placement: {
        ...
        eligible: true,
        companies: ['Infosys', 'TCS', 'Microsoft', 'Amazon', 'Accenture', 'Wipro', 'Cognizant', 'Deloitte India'],
        internships: ['AI Research Internship', 'Product Engineering Intern', 'Full Stack Developer Intern', 'Data Engineering Trainee'],
        resumeReady: true,
      },
      academicPerformance: {
        cgpa: Number((7.8 + ((seed % 15) * 0.11)).toFixed(2)),
        credits: 118,
        achievements: ['Hackathon finalist 2025', 'Class topper', 'Research poster selected', 'IEEE Student Paper Award', 'Open Source Contributor'],
        skills: [...allSkills.slice(0, 5 + (seed % 3)), 'Docker', 'REST APIs', 'Git & GitHub'],
        certifications: ['Python Essentials', 'SQL Fundamentals', 'Machine Learning Basics', 'Cloud Architecture Practitioner', 'Cybersecurity Fundamentals'],
        projects: ['CampusConnect OS', 'AI Attendance Assistant', 'Smart Timetable Generator', 'Canteen Pre-order Engine'],
        internships: ['AI Lab Intern', 'Software Developer Intern', 'Cloud Systems Engineering Intern'],
      },
      semesterMarks,
      notifications: [
        { id: `notif-${index + 1}-1`, title: 'New timetable update', body: 'Your semester timetable has been updated with room allocations for this week.', type: 'academic', time: '2h ago', unread: true },
        { id: `notif-${index + 1}-2`, title: 'Attendance threshold notice', body: 'Your attendance for Machine Learning is currently at 82%. Keep it above 75%.', type: 'attendance', time: '1d ago', unread: false },
        { id: `notif-${index + 1}-3`, title: 'Campus Placement Drive Alert', body: 'Infosys & TCS placement drives are opening for registration starting Monday.', type: 'placement', time: '3d ago', unread: true },
        { id: `notif-${index + 1}-4`, title: 'Canteen slot confirmation', body: 'Your lunch pre-order pickup slot for South Canteen is confirmed for 12:45 PM.', type: 'academic', time: '4h ago', unread: false },
        { id: `notif-${index + 1}-5`, title: 'Library Book Due Reminder', body: 'Please return or renew your borrowed library textbook before Friday 5:00 PM.', type: 'academic', time: '5h ago', unread: true },
      ],
    };
  });
}
